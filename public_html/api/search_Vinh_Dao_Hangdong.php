...
if ($_SERVER['REQUEST_METHOD']=='POST') {
       ...
       class BaiVietChua
    {
      ...
      $sql = "SELECT baiviet.id, baiviet.TenBaiViet, baiviet.TomTat, (select COUNT(*) from likes where likes.BaiViet_id=baiviet.id) as SoLike, baiviet.ThoiGianDang, baiviet.AnhDaiDien, baiviet.NoiDung FROM baiviet inner join baivietdanhmuc on baiviet.id = baivietdanhmuc.BaiViet_id inner join danhmuc on danhmuc.id=baivietdanhmuc.DanhMuc_id WHERE (danhmuc.id = $idDanhMuc OR danhmuc.DanhMucCha_id = $idDanhMuc) AND baiviet.XuatBan = 1";
